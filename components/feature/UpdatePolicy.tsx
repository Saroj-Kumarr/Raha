          ...
          <div className="max-w-lg mx-auto lg:mx-0 md:text-center lg:text-left">
            <div className="mb-4">
              <h1 className="text-2xl sm:text-3xl lg:text-4xl text-[#00150E] leading-tight">
                <span className="text-[#03704F] font-medium"> Update </span>
                Policies Without
              </h1>
              <h1 className="text-2xl sm:text-3xl lg:text-4xl text-[#00150E] leading-tight">
                Paper Trails
            ...
            <p className="text-base sm:text-lg text-[#747C90] leading-relaxed mb-6 sm:mb-8">
              Make policy changes effortlessly—add dependents, update coverage,
              or process exits. All changes are logged and traceable for
              compliance.
            </p>
