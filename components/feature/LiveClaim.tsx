          ...
          <div className="max-w-lg mx-auto lg:mx-0 md:text-center lg:text-left">
            <div className="mb-4">
              <h1 className="text-2xl sm:text-3xl lg:text-4xl text-[#00150E] leading-tight">
                Live <span className="text-[#B76F06] font-medium">Claim</span>{" "}
                Status, No More
              </h1>
              <h1 className="text-2xl sm:text-3xl lg:text-4xl text-[#00150E] leading-tight">
                Guesswork
            ...
            <p className="text-base sm:text-lg text-[#747C90] leading-relaxed mb-6 sm:mb-8">
              Track every claim from submission to settlement with real-time
              visibility. Filter by employee, claim stage, or TAT—and keep
              everyone informed.
            </p>
